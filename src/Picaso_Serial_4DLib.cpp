...
#ifdef AVR
void Picaso_Serial_4DLib::print(const __FlashStringHelper *ifsh)
{
...
void Picaso_Serial_4DLib::print(const String &s)
{
	int len = s.length();
	char arr[len + 1];
...
void Picaso_Serial_4DLib::print(const char str[])
{
  int len = strlen(str);
  for(int x = 0; x<len; x++)
  {
...
void Picaso_Serial_4DLib::print(char c)
{
  putCH(c);
}

void Picaso_Serial_4DLib::print(unsigned char b, int base)
{
  print((unsigned long) b, base);
}

void Picaso_Serial_4DLib::print(int n, int base)
{
  print((long) n, base);
}

void Picaso_Serial_4DLib::print(unsigned int n, int base)
{
  print((unsigned long) n, base);
}

void Picaso_Serial_4DLib::print(long n, int base)
{
...
void Picaso_Serial_4DLib::print(unsigned long n, int base)
{
  printNumber(n, base);
}

void Picaso_Serial_4DLib::print(double n, int digits)
{
  printFloat(n, digits);
}
...
void Picaso_Serial_4DLib::println(const __FlashStringHelper *ifsh)
{
  print(ifsh);
  putCH('\n');
  putCH('\r');
...
void Picaso_Serial_4DLib::println(const String &s)
{
  print(s);
  putCH('\n');
  putCH('\r');
...
void Picaso_Serial_4DLib::println(const char c[])
{
  print(c);
  putCH('\n');
  putCH('\r');
...
void Picaso_Serial_4DLib::println(char c)
{
  print((char)c);
  putCH('\n');
  putCH('\r');
...
void Picaso_Serial_4DLib::println(unsigned char b, int base)
{
...
void Picaso_Serial_4DLib::println(int num, int base)
{
  print((int)num, base);
  putCH('\n');
  putCH('\r');
...
void Picaso_Serial_4DLib::println(unsigned int num, int base)
{
...
void Picaso_Serial_4DLib::println(long num, int base)
{
  print((long)num, base);
  putCH('\n');
  putCH('\r');
...
void Picaso_Serial_4DLib::println(unsigned long num, int base)
{
...
void Picaso_Serial_4DLib::println(double num, int digits)
{
...
void Picaso_Serial_4DLib::printNumber(unsigned long n, uint8_t base) {
...
void Picaso_Serial_4DLib::printFloat(double number, uint8_t digits) 
{ 
  size_t n = 0;
